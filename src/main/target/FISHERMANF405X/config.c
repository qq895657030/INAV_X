...
void targetConfiguration(void)
{
    ...
    blackboxConfigMutable()->rate_num = 1; //日志频率为全速的四分之一
    ...
    modeActivationConditionsMutable(4)->modeId = BOXNAVRTH;
    ...
    modeActivationConditionsMutable(5)->modeId = BOXUSER1;
    modeActivationConditionsMutable(5)->auxChannelIndex = 4; // AUX5 / channel 9
